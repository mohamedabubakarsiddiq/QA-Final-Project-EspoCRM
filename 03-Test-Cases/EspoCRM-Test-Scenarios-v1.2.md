...
> **Traceability basis:** This scenario baseline is aligned to the current Detailed Test Cases workbook and Master RTM.
...
| Scenario ID | Test Scenario | Requirement ID | Test Case |
|---|---|---|---|
...
| Scenario ID | Test Scenario | Requirement ID | Test Cases |
|---|---|---|---|
...
| TS-ACC-016 | Verify All filter displays available Accounts | FR-ACC-016 | TC-ACC-032 to TC-ACC-036 |
...
| TS-ACC-019 | Verify Delete action displays confirmation | FR-ACC-019 | TC-ACC-015 to TC-ACC-017 |
...
| TS-ACC-022 | Verify Followers section allows a user to be followed | FR-ACC-022 | TC-ACC-021 to TC-ACC-024 |
...
| TS-ACC-025 | Verify locked Account cannot be edited | FR-ACC-025 | TC-ACC-027 to TC-ACC-029 |
...
Execution results and defect references remain maintained in the Master RTM and Detailed Test Cases workbook.

## 7. Revision History

| Version | Date | Description |
|---|---|---|
| 1.2 | 19-Sep-2026 | Aligned the active scenario baseline to Login, Accounts and Contacts and the current 90-case traceability baseline. Leads and Opportunities remain de-scoped. |
| 1.1 | 19-Sep-2026 | Reduced active scope to Login, Accounts and Contacts. |
